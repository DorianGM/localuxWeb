 ...
 */
class FormulaireavecchauffeurRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Formuleavecchauffeur $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Formuleavecchauffeur $entity, bool $flush = true): void
    {
